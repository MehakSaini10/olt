...
function StudentFooter() {
  useEffect(() => {
    // Create a link element for the tailwind.css stylesheet
    const tailwindLink = document.createElement('link');
    tailwindLink.rel = 'stylesheet';
    tailwindLink.href = 'https://demos.creative-tim.com/notus-js/assets/styles/tailwind.css';
    document.head.appendChild(tailwindLink);

    // Create a link element for the fontawesome-free css stylesheet
    ...
    // Clean up function to remove the created link elements when component unmounts
    return () => {
...
<footer className="relative bg-blueGray-200 pt-8 pb-6">
  ...
  Copyright © <span id="get-current-year">2021</span><a href="" className="text-blueGray-500 hover:text-gray-800" target="_blank"> Notus JS by </a>
