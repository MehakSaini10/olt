...
const  SignUp=() =>{
    ...
    const submitHandler=async(e)=>{
        ...
        try{
            const res=await axios.post('http://localhost:5000/api/student/register',{name,email,phone,password})
            if(res.status===200){
  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0" style={{background:"linear-gradient(90deg,rgba(255,255,255,1) 0%, rgba(72,196,237,1) 67%)"}}>
        <a href="#" className="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
            <img className="w-8 h-8 mr-2" src="/public/EduTrackLogo.png" alt="logo" />
            EduTrack   
        </a>
            ...
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <div>
                    ...
                    <div>
                        ...
                        <input type="number" name="number" id="number" value={phone}  onChange={(e)=>setPhone(e.target.value)}  className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter your email" required=""/>
